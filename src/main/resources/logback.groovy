...
logger( "part2dataframes.ColumnsAndExpressionsExercises", DEBUG )
logger( "part2dataframes.Aggregations", DEBUG )
logger( "part2dataframes.AggregationsExercises", DEBUG )
root( WARN, [ "STDOUT" ] )
